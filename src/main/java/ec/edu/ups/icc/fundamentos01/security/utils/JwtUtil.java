...
public class JwtUtil {
    ...
    /*
     * Genera un token JWT desde la autenticación (flujo de login).
     */
    ...
    /*
     * Genera un token JWT desde UserDetailsImpl directamente (flujo de registro).
     */
    ...
    /*
     * Valida el token JWT: firma, formato y expiración.
     */
