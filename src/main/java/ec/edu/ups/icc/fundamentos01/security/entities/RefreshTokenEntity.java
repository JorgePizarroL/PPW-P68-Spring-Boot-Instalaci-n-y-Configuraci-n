...
public class RefreshTokenEntity extends BaseEntity {
     ...
     *
     * En esta práctica se maneja una sola sesión activa por usuario,
    ...
    /*
     * Valor del refresh token (JWT completo).
     *
     * En producción se recomienda guardar un hash del token,
     * no el token en texto plano. Aquí se guarda completo para
     ...
     *
     * Se guarda también en base de datos (además de estar codificada
     * dentro del JWT) para facilitar consultas y control del ciclo
     * de vida del token.
     */
